...
| `chrx_lrr_median`, `chry_lrr_median`, `chrx_f_stat`, `peddy_sex`, `sex_status` | `sex_check_chrXY_lrr.tsv` | Sex check cross-tabulation (LRR-based, F-stat, peddy, concordance) |
